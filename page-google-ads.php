        ...
        <div class="col-md-12" style="padding: 20px 0;">
            ...
            <div class="row">
                <div class="col-md-10 col-lg-offset-1">
                    ...
                    <div class="col-lg-6 col-md-6 hover-c" style="position:relative">
                        <div class="col-md-3" style="text-align:center; padding-top:25px">
                            <i class="fa fa-fw fa-4x fa-line-chart" aria-hidden="true"></i>
                        </div>
                        <div class="col-md-9">
                            <h3>Đồng bộ với chiến lược kinh doanh</h3>
                    ...
                    <div class="col-lg-6 col-md-6 hover-c" style="text-align:left; position:relative">
                        ...
                        <div class="col-md-9">
                            ...
                            <p>Hãy trải nghiệm dịch vụ của chúng tôi để cảm nhận</p>
                        </div>
                    </div>
                                ...
                                <div class="col-md-4 package should-margin-bottom should-margin-bottom">
                                    <div class="step-contain">
                                        <div class="step1 step">
                                            ...
                                            <div style="font-size:20px">Nhận yêu cầu</div>
                                        </div>
                                        <div class="step-desc">
                                ...
                                <div class="col-md-4 package should-margin-bottom should-margin-bottom">
                                    <div class="step-contain">
                                        <div class="step1 step">
                                            ...
                                            <div style="font-size:20px">Thống nhất giải pháp</div>
                                        </div>
                                        <div class="step-desc">
                                ...
                                <div class="col-md-4 package should-margin-bottom should-margin-bottom">
                                    <div class="step-contain">
                                        <div class="step1 step">
                                            ...
                                            <div style="font-size:20px">Set mẫu quảng cáo ban đầu</div>
                                        </div>
                                        <div class="step-desc">
                                ...
                                <div class="col-md-4 package should-margin-bottom should-margin-bottom">
                                    <div class="step-contain">
                                        <div class="step1 step">
                                            ...
                                            <div style="font-size:20px">Tối ưu hóa mẫu quảng cáo</div>
                                        </div>
                                        <div class="step-desc">
                                ...
                                <div class="col-md-4 package should-margin-bottom should-margin-bottom">
                                    <div class="step-contain">
                                        <div class="step1 step">
                                            ...
                                            <div style="font-size:20px">Báo cáo định kỳ</div>
                                        </div>
                                        <div class="step-desc">
        ...
        <div class="col-md-10 col-lg-offset-1">
            ...
            <div class="col-md-4">
                <div style="text-align:center">
                    <img style="height:150px; width:150px; border-radius:50%" alt="Hình ảnh" src="<?php bloginfo('template_directory');?>/image/p1.jpg" tppabs="http://magica.top/Imgs/p1.jpg" />
                </div>
                <div style="text-align:center; color:#6ab139;margin:10px">
                    <i class="fa fa-fw fa-2x fa-quote-right"></i>
                </div>
                <div>
                    <p style="text-align:justify">Sau khi chạy quảng cáo, lượng khách hàng của tôi tăng lên rõ rệt. Tôi không còn phải lo lắng về chiến lược quảng cáo.</p>               
            ...
            <div class="col-md-4">
                ...
                <div>
                    <p style="text-align:justify">Nhờ có quảng cáo Google, công ty đã giúp tôi có lượng khách hàng ổn định trong thời gian dài, giúp giảm chi phí</p>
            ...
            <div class="col-md-4">
                ...
                <div>
                    <p style="text-align:justify">Giá rẻ nhưng lại rất hiệu quả. Cám ơn công ty Magic</p>
