...
<head>
    ...
    <script type="text/javascript" src="http://trainee.magica.top/wp-content/plugins/wysija-newsletters/js/validate/jquery.validationEngine.js?ver=2.7.11.1"></script>
    ...
    <script type="text/javascript">
            /* <![CDATA[ */
            var wysijaAJAX = {"action":"wysija_ajax","controller":"subscribers","ajaxurl":"http://trainee.magica.top/wp-admin/admin-ajax.php","loadingTrans":"Loading..."};
            /* ]]> */
    </script>
    <script type="text/javascript" src="http://trainee.magica.top/wp-content/plugins/wysija-newsletters/js/front-subscribers.js?ver=2.7.11.1"></script>
    <script type="text/javascript">
